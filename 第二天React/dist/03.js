	...
	_createClass(Slider, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'slider' },
				_react2.default.createElement(GoTop, { parentMethod: this.method.bind(this, 123, 456), text: this.state.text })
			);
		}
	}]);
...
var GoTop = function (_Component2) {
	...
	function GoTop() {
		...
		return _possibleConstructorReturn(this, (GoTop.__proto__ || Object.getPrototypeOf(GoTop)).apply(this, arguments));
	}
	...
	_createClass(GoTop, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'span',
				{ onClick: this.props.parentMethod.bind(this, 100, 200) },
				this.props.text
			);
			// 在子组件方法中执行
...
(0, _reactDom.render)(_react2.default.createElement(Slider, { title: '\u7231\u521B\u8BFE\u5802' }), app);
