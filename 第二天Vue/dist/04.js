...
// module
exports.push([module.i, "body {\n  background: #efefef; }\n\n.main {\n  width: 600px;\n  margin: 100px auto;\n  background: #fff;\n  border: 1px solid #ccc;\n  padding-top: 100px;\n  position: relative;\n  height: 400px; }\n  .main label {\n    margin-left: 100px;\n    margin-right: 20px; }\n  .main input {\n    padding: 10px;\n    width: 300px; }\n  .main ul {\n    position: absolute;\n    top: 122px;\n    left: 172px;\n    width: 322px;\n    padding: 0;\n    border: 1px solid #ccc;\n    background: #fff; }\n    .main ul li {\n      list-style: none;\n      padding: 6px 10px;\n      font-size: 14px; }\n      .main ul li:hover, .main ul li.choose {\n        background: #efefef; }\n\n.layer {\n  width: 400px;\n  height: 400px;\n  background: green; }\n\n.demo-enter,\n.demo-leave-to {\n  width: 0;\n  height: 0;\n  opacity: 0; }\n\n.demo-enter-active,\n.demo-leave-active {\n  transition: all 1s; }\n", ""]);
...
new _vue2.default({
	...
	computed: {
		...
		dealEmail: function dealEmail() {
			...
			if (this.msg.indexOf('@') >= 0) {
				...
				// console.log(str)
				// 过滤数组
				return this.email.filter(function (item) {
					// 添加后缀
					var dealItem = item + (item === '189' ? '.c' : '.co');
					// 条件是：以str开头
	...
	methods: {
		// 点击并选中li
		clickChooseLi: function clickChooseLi(e) {
			// 获取当前元素
			var dom = e.target;
			// 获取dom的内容，并存储在msg中
   ...
   * @len 		当前li的长度
   **/
		getIndexByNum: function getIndexByNum(len) {
			// 以前算法：处理边界值
			// 今天换一种算法，
		...
		// 改变li的样式
		changeLiStyle: function changeLiStyle() {
			// 根据li的长度，获取当前li的索引值
			var lis = document.getElementsByTagName('li');
			// 长度
			var len = lis.length;
			// 根据num获取真正的索引值
			var index = this.getIndexByNum(len);
			// 排他法，设置样式
			// 遍历
			// for (var i = 0; i < len; i++) {}
			// 将类数组对象转化成数组
			...
			.forEach(function (li, i) {
				return li.className = i === index ? 'choose' : '';
			});
		},

		// 选中上一个li
		choosePrevLi: function choosePrevLi(e) {
			// 阻止默认行为
			e.preventDefault();
			// 如果移动过，才能减
			if (this.hasMove) {
		...
		// 选中下一个li
		chooseNextLi: function chooseNextLi() {
			// 增加num
			this.num++;
			// 改变li的样式
			this.changeLiStyle();
		...
		// 选中当前li
		chooseCurrentLi: function chooseCurrentLi() {
			// 根据当前li获取索引值
			var lis = document.getElementsByTagName('li');
			// 获取长度
			var len = lis.length;
