...
var Skin = function (_Component) {
	...
	_createClass(Skin, [{
		...
		value: function componentDidMount() {
			...
			// 请求数据
			_axios2.default.get('data/skin.json')
			// 监听数据返回
			.then(function (_ref) {
				var data = _ref.data;
		...
		value: function changeBackground(e, id) {
		...
		value: function createList() {
			...
			return this.state.data.map(function (item, index) {
				return _react2.default.createElement(
					'li',
					{ key: index, 'data-id': item.id, onClick: function onClick(e) {
							return _this3.changeBackground(e, item.id);
						} },
					_react2.default.createElement('img', { src: 'img/skin/' + item.src, alt: '' }),
...
(0, _reactDom.render)(_react2.default.createElement(Skin, null), app);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/less-loader/dist/cjs.js!./skin.less", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/less-loader/dist/cjs.js!./skin.less");
...
// module
exports.push([module.i, "* {\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\nbody {\n  background-size: cover;\n  background-attachment: fixed;\n}\n.skin .skin-container {\n  width: 1118px;\n  margin: 40px auto;\n}\n.skin .skin-container ul {\n  margin-right: -10px;\n}\n.skin .skin-container li {\n  width: 178px;\n  margin-right: 10px;\n  margin-bottom: 10px;\n  text-align: center;\n  float: left;\n}\n.skin .skin-container img {\n  width: 100%;\n  height: 98px;\n}\n.skin .skin-container p {\n  line-height: 30px;\n  font-size: 16px;\n}\n", ""]);
