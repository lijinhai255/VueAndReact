...
Nav.defaultProps = {
	...
	// 使用组件
};(0, _reactDom.render)(_react2.default.createElement(Nav, { data: ['教你理财', '天猫购物季', '千图网'] }), app1);
(0, _reactDom.render)(_react2.default.createElement(Nav, { data: ['新浪•NBA', '搜狐体育', 'CCTV5', '虎扑体育', '直播吧'] }), app2);
(0, _reactDom.render)(_react2.default.createElement(Nav, null), app3);
