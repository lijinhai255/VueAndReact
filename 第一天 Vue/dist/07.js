...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } // 引入vue
...
var data = {
	msg: 'hello ickt'
	// 实例化创建vm对象
};var app = new _vue2.default((_ref = {}, _defineProperty(_ref, 'e' + 'l', '#app'), _defineProperty(_ref, 'data', data), _defineProperty(_ref, 'watch', {
	// 监听msg变化
	msg: function msg() {
