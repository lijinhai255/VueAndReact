...
var Demo = function (_Component) {
	...
	_createClass(Demo, [{
		key: 'createChildList',
		value: function createChildList(arr) {
			// 根据arr成员，返回新闻
		...
		value: function createList() {
			...
			// this.num对index取余
			var num = this.state.num % this.props.data.length;
			// 创建li
...
(0, _reactDom.render)(_react2.default.createElement(Demo, { data: [['玛莎母亲老公出轨'], ['快鹿高管被判无期'], ['济南大白宫被拆'], ['郜林激动怒斥裁判']], num: '10' }), app);

(0, _reactDom.render)(_react2.default.createElement(Demo, { data: [['曝张柏芝豪宅装修', '孤存6杀吃鸡'], ['李承铉为女儿庆生', '中铁成都局回应'], ['广德申报火锅之乡', '库里三分创纪录'], ['小罐茶 智商税', '北京地铁拆座椅'], ['青岛香奈儿遭打砸', '业主割断安全绳']] }), app2);
