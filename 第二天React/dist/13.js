...
var Parent = function (_Component) {
	...
	_createClass(Parent, [{
		key: 'parentMethod',
		value: function parentMethod(msg) {
			// 3 父组件接收数据，并更新状态
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(Child, { method: function method(msg) {
						return _this2.setState({ msg: msg });
					} }),
				_react2.default.createElement(Other, { msg: this.state.msg })
			);
		}
	}]);
	...
	_createClass(Child, [{
		...
		value: function render() {
			...
			return _react2.default.createElement('input', { type: 'text', onChange: function onChange(e) {
					return _this4.props.method(e.target.value);
				} });
		}
	}]);
...
(0, _reactDom.render)(_react2.default.createElement(Parent, null), app);
