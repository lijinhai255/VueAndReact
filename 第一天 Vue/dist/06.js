...
// 自定义过滤器
_vue2.default.filter('uppercase', function () {
...
// 驼峰式命名
// 引入vue
_vue2.default.filter('toCamel', function () {
	var str = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
	var firstCharIsUpper = arguments[1];
	...
	return str.replace(/[-_]([a-z])?/g, function (match) {
		var $1 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
		return $1.toUpperCase();
	});
});
