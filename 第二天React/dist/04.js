	...
	_createClass(Slider, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'slider' },
				_react2.default.createElement(GoTop, { text: this.state.text })
			);
		}
	}]);
...
var GoTop = function (_Component2) {
	_inherits(GoTop, _Component2);

	// 构造函数
	function GoTop(props) {
		_classCallCheck(this, GoTop);

		var _this2 = _possibleConstructorReturn(this, (GoTop.__proto__ || Object.getPrototypeOf(GoTop)).call(this, props));
	...
	_createClass(GoTop, [{
		...
		value: function componentWillUpdate(newProps, newState) {
			console.log(333, 'componentWillUpdate', this.props, newProps, 'state', this.state, newState, (0, _reactDom.findDOMNode)(this).innerHTML);
		}
		// 4 渲染更新组件
		...
		value: function componentDidUpdate(oldProps, oldState) {
			console.log(555, 'componentDidUpdate', this.props, oldProps, 'state', this.state, oldState, (0, _reactDom.findDOMNode)(this).innerHTML);
		}
		// 组件创建完成
		...
		value: function componentDidMount() {
			...
			window.addEventListener('scroll', function () {
				...
				// 如果高于500，显示返回顶部
				if (scrollY > 500) {
					_this3.setState({ text: '返回顶部' });
				} else {
					_this3.setState({ text: '头条新闻' });
				}
			});
		}
	}]);
...
(0, _reactDom.render)(_react2.default.createElement(Slider, null), app);
