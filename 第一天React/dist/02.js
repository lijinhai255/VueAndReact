...
var Demo = function (_Component) {
	...
	_createClass(Demo, [{
		...
		value: function render() {
			...
			null,
			// 第三个参数开始，表示子虚拟DOM
			(0, _react.createElement)('li', null, '教你理财'), (0, _react.createElement)('li', null, '天猫购物季'), (0, _react.createElement)('li', null, '千图网'));
		}
	}]);
...
var demo = (0, _react.createElement)(Demo);

// 使用render方法渲染
// render(demo, document.getElementById('app'))
// 小技巧：可以直接用id获取元素
// 项目中，和工作中，不要用。
(0, _reactDom.render)(demo, app);
