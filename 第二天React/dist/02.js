...
var Demo = function (_Component) {
	...
	_createClass(Demo, [{
		...
		value: function componentWillMount() {
			console.log(333, 'componentWillMount', this.state, this.props, (0, _reactDom.findDOMNode)(this));
		}
		// 4 渲染方法
		...
		value: function componentDidMount() {
			console.log(555, 'componentDidMount', this.state, this.props, (0, _reactDom.findDOMNode)(this));
		}
	}]);
