...
// 定义常量
var ADD_NUM = 'addNum';
var REMOVE_NUM = 'removeNum';
// 定义actions
var addNum5 = { type: ADD_NUM, data: 5 };
var removeNum2 = { type: REMOVE_NUM, data: 2
	// 定义reducer
};function reducer() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ onClick: function onClick(e) {
							return dispatch(removeNum2);
						} },
					'\u51CF\u5C112'
				),
				_react2.default.createElement(AddNum, { dispatch: dispatch, addNum: addNum }),
				_react2.default.createElement(ShowNum, { num: state }),
				_react2.default.createElement(DealDemo, null)
			);
		}
	}]);
...
var AddNum = function (_Component2) {
	_inherits(AddNum, _Component2);

	function AddNum() {
		_classCallCheck(this, AddNum);

		return _possibleConstructorReturn(this, (AddNum.__proto__ || Object.getPrototypeOf(AddNum)).apply(this, arguments));
	}
...
var ShowNum = function (_Component3) {
	_inherits(ShowNum, _Component3);

	function ShowNum() {
		_classCallCheck(this, ShowNum);

		return _possibleConstructorReturn(this, (ShowNum.__proto__ || Object.getPrototypeOf(ShowNum)).apply(this, arguments));
	}

	_createClass(ShowNum, [{
		key: 'render',
		value: function render() {
...
function mapDispatchToProps(dispatch) {
	...
	return {
		...
		addNum: function addNum(data) {
			// 发布消息
			dispatch({ type: ADD_NUM, data: data });
		}
	};
}
// 定义组件接收state和dispatch的方式
var dealFn = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps);
// 处理应用程序组件了
var DealApp = dealFn(App);
// 拓展新的组件
var DealDemo = dealFn(Demo);
// 提供store对象
(0, _reactDom.render)(
// 通过store属性，提供store对象
_react2.default.createElement(
	...
	{ store: store },
	_react2.default.createElement(DealApp, null)
), app);
...
*/
var aa=__webpack_require__(2),l=__webpack_require__(8),B=__webpack_require__(9),C=__webpack_require__(1),ba=__webpack_require__(10),da=__webpack_require__(11),ea=__webpack_require__(12),fa=__webpack_require__(13),ia=__webpack_require__(14),D=__webpack_require__(15);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(37), __webpack_require__(50)(module)))
