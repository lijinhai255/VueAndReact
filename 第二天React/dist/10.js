...
var _imageZoom = __webpack_require__(43);
...
var Demo = function (_Component) {
	...
	_createClass(Demo, [{
		...
		value: function componentDidMount() {
			...
			new _imageZoom2.default(this.refs.container, url, width);
		}
		// 渲染
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'demo' },
				_react2.default.createElement('div', { className: 'image-container', ref: 'container' }),
				_react2.default.createElement(
					'div',
					{ className: 'small-image' },
					_react2.default.createElement('img', { src: this.state.url, width: '60', height: '60', alt: '' })
				)
			);
		}
	}]);
...
(0, _reactDom.render)(_react2.default.createElement(Demo, null), app);
...
var ImageZoom = function () {
  ...
  * @width 		容器宽度
  *****/
	function ImageZoom(container, url, width) {
	...
	_createClass(ImageZoom, [{
		...
		value: function init() {
			...
			img.onload = function () {
				...
				// 缩放比例
				_this.zoom = img.width / _this.width;
				// 图片等比例放缩。 ih / iw = h / w  =>  h = w * ih / iw
				// 容器高度
				_this.height = _this.width * img.height / img.width;
				// 图片加载完成，构建视图
				_this.createView();
				// 绑定事件
				_this.bindEvent();
		...
		key: 'css',
		value: function css(dom, key, value) {
		...
		value: function bindEvent() {
			...
			this.container.onmouseenter = function () {
				// 显示弹层
				_this2.css(_this2.layer, 'display', 'block');
			};
			// 鼠标移走，隐藏弹层
			this.container.onmouseleave = function () {
				// 隐藏弹层
				_this2.css(_this2.layer, 'display', 'none');
			};
			// 鼠标移动，更改放大图片的位置
			this.container.onmousemove = function (e) {
				...
				if (x * _this2.zoom + _this2.width <= _this2.imageWidth) {
					// 可以修改横坐标
					_this2.css(_this2.layer, 'backgroundPositionX', -x * _this2.zoom + 'px');
				}
				// 如果纵坐标移动的距离，加上容器的高度，小于图片的高度，我们可以移动背景
				if (y * _this2.zoom + _this2.height <= _this2.imageHeight) {
					// 可以移动纵坐标
					_this2.css(_this2.layer, 'backgroundPositionY', -y * _this2.zoom + 'px');
				}
			};
		}
	}]);
