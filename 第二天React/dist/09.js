...
var Demo = function (_Component) {
	...
	_createClass(Demo, [{
		...
		value: function showResult() {
			...
			var color = [];
			// 获取元素，
			var options = this.refs.color.options;
			// 遍历options
		...
		key: 'changeResult',
		value: function changeResult() {
			// 将结果改成
			var choose = ['isRed', 'isGreen'];
			...
			.forEach(function (item) {
				return item.selected = choose.indexOf(item.value) >= 0 ? true : false;
			});
		}
	}, {
		key: 'render',
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'select',
						{ defaultValue: ['isBlue'], ref: 'color', multiple: true },
						_react2.default.createElement(
							'option',
							{ value: 'isRed' },
							'red'
